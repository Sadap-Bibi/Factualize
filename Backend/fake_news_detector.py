...
>>>>>>> e7af450287f828c7ffb18f0c48c123de95003070
...
<<<<<<< HEAD
        # Ensure a headline is selected if there's a match
        closest_headline = "No matching headline found."
        if news_pairs and max_similarity > 0:
            closest_headline = max(news_pairs, key=lambda x: x[0])[1]
